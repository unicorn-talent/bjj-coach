...
class AdminController extends Controller
{
	...
	{
		$videocategories      = Videocategories::orderBy('name')->get();
		$totalVideoCategories = count( $videocategories );

		return view('admin.videocategories', compact( 'videocategories', 'totalVideoCategories' ));
	}//<--- END METHOD

	public function addvideoCategories()
	{
		return view('admin.add-videocategories');
	}//<--- END METHOD

	public function storevideoCategories(Request $request) {
	...
	$thumbnail = '';
    	...
    	return redirect('panel/admin/video-categories');

	}//<--- END METHOD

	public function editvideoCategories($id) {

		$categories        = Videocategories::find( $id );

		return view('admin.edit-videocategories')->with('categories',$categories);

	}//<--- END METHOD

	public function updatevideoCategories(Request $request)
	{
		$categories        = Videocategories::find($request->id);
		$temp            = 'public/temp/'; // Temp
	  $path            = 'public/img-category/'; // Path General

	  if(!isset($categories)) {
			return redirect('panel/admin/videocategories');
		}
	...
	public function deletevideoCategories($id)
	{

			$categories   = Videocategories::findOrFail($id);
			$thumbnail    = 'public/img-category/'.$categories->image; // Path General
