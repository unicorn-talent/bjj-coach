...
// Block dragging on images
 ...
 $(document).on('click','.sendReport', function(e){
	...
	$(document).ready(function(){
 	...
 	// Toogle video category dropdown on POST create form
 	$(document).on('click','#btnvideocategories',function () {
		 //var input = $('#divvideocategories');

	 		$('#divvideocategories').slideToggle(100);
			//input.toggleClass('active');
			$(this).toggleClass('btn-active-hover');
