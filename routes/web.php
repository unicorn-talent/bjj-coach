...
Route::group(['middleware' => 'private.content'], function() {
	...
	//Video Category
	Route::get('videocategory/{slug}/{type?}','HomeController@videocategory')->name('seo');
 ...
 Route::group(['middleware' => 'role'], function() {
	...
	// Video Categories
 	Route::get('panel/admin/video-categories','AdminController@videocategories');
 	Route::get('panel/admin/video-categories/add','AdminController@addvideoCategories');
 	Route::post('panel/admin/video-categories/add','AdminController@storevideoCategories');
 	Route::get('panel/admin/video-categories/edit/{id}','AdminController@editvideoCategories')->where(array( 'id' => '[0-9]+'));
 	Route::post('panel/admin/video-categories/update','AdminController@updatevideoCategories');
 	Route::post('panel/admin/video-categories/delete/{id}','AdminController@deletevideoCategories')->where(array( 'id' => '[0-9]+'));
