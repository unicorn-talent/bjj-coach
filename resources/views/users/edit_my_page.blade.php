          ...
          <div class="row form-group mb-0">
            ...
            <div class="col-md-6">
                <div class="input-group mb-4">
                  ...
                  <input class="form-control" name="IBJJF_Rank" required placeholder="{{trans('IBJJF Rank')}}"   type="text" value="{{auth()->user()->IBJJF_Rank}}">
                </div>
              </div><!-- ./col-md-6 -->
              ...
              <div class="col-md-6">
                ...
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fa fa-language"></i></span>
					...
					<input class="form-control" name="ADCC_Awards" required placeholder="{{trans('ADCC Awards')}}"  type="text" value="{{auth()->user()->ADCC_Awards}}">
                  </div>
                </div><!-- ./col-md-6 -->
            </div><!-- End Row Form Group -->
        ...
        <div class="row form-group mb-0">
            <div class="col-md-6">
              ...
              <div class="col-md-6" id="billing">
                ...
                <select required name="categories_id[]" multiple="multiple" class="form-control custom-select" >
				  @foreach (Categories::where('mode','on')->orderBy('name')->get() as $category)
					<option @if (in_array($category->id, $categories_ids))  selected="selected" @endif value="{{$category->id}}">{{ Lang::has('categories.' . $category->slug) ? __('categories.' . $category->slug) : $category->name }}</option>
				  @endforeach
				 </select>
                </div>
                </div><!-- ./col-md-6 -->
