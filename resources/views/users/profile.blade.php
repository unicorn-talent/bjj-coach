  ...
  <div class="container py-4 pb-5">
    <div class="row">
      ...
      <div class="sticky-top navbar-collapse collapse d-lg-block" id="navbarUserHome">
          ...
          <div class="card-body">
            ...
            @endif
              ...
              <small class="btn-block m-0 mb-1">
			   ...
			   @if (isset($user->IBJJF_Rank))
			  <small class="btn-block m-0 mb-1">
                <i class="far fa-user-circle mr-1"></i> {{ $user->IBJJF_Rank }}
              </small>
			  @endif
			  
			   @if (isset($user->ADCC_Awards))
			  <small class="btn-block m-0 mb-1">
                <i class="far fa-user-circle mr-1"></i> {{ $user->ADCC_Awards }}
              </small>
			@endif
            ...
            @endif
              ...
              <div class="w-100">
				...
				@foreach($categoriesids as $categoriesids_k) 
					...
					<a href="{{url('category', $categoriesids_k->slug)}}" class="badge badge-pill badge-secondary">
					  <i class="fa fa-tag mr-1"></i> {{ Lang::has('categories.' . $categoriesids_k->slug) ? __('categories.' . $categoriesids_k->slug) : $categoriesids_k->name }}
					</a>
				@endforeach
              </div>
            @endif
        ...
        <button type="button" class="btn btn-secondary btn-block mb-2 d-lg-none text-word-break" type="button" data-toggle="collapse" data-target="#navbarUserHomevideo" aria-controls="navbarCollapse" aria-expanded="false">
      		<i class="fa fa-bars mr-1"></i> {{ trans('users.instructional_videos') }}
      	</button>

      <div class="sticky-top navbar-collapse collapse d-lg-block" id="navbarUserHomevideo">
        <div class="card mb-3">
          <div class="card-body">
            <h6 class="card-title">{{ trans('users.instructional_videos') }}</h6>
            

              @if ($user->verified_id == 'yes')
              <div class="w-100">
				 
				@foreach($videocategoriesids as $categoriesids_k) 
				
					<a href="{{url('videocategory', $categoriesids_k->slug)}}" class="badge badge-pill badge-secondary">
					  <i class="fa fa-tag mr-1"></i> {{ Lang::has('categories.' . $categoriesids_k->slug) ? __('categories.' . $categoriesids_k->slug) : $categoriesids_k->name }}
					</a>
