      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{ url('panel/admin/video-categories/add') }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-footer">
                    <a href="{{ url('panel/admin/video-categories') }}" class="btn btn-default">{{ trans('admin.cancel') }}</a>
