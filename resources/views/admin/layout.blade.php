        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <li @if(Request::is('panel/admin/languages')) class="active" @endif>
            ...
            <!-- Links -->
            <li @if(Request::is('panel/admin/video-categories')) class="active" @endif>
            	<a href="{{ url('panel/admin/video-categories') }}"><i class="fa fa-video"></i> <span>{{ trans('admin.videocategories') }}</span></a>
            </li><!-- ./Links -->
